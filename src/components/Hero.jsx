    ...
    return(
        ...
        <div className="w-full max-w-md md:max-w-lg flex flex-col gap-4 md:gap-5 px-4 md:px-0 md:ml-12 lg:ml-20 items-center md:items-start text-center md:text-left">
          ...
          <div className="flex gap-3 sm:gap-4 w-full justify-center md:justify-start">
            <Link to="/shop" className="bg-[#0A2D1B] hover:bg-[#061c11] text-white font-semibold px-4 py-2.5 rounded-md text-xs sm:text-sm transition shadow-md cursor-pointer flex-1 sm:flex-initial text-center leading-normal">Shop Our Products</Link>
            <Link to="/our-story" className="text-[#0A2D1B] hover:bg-gray-50 font-semibold bg-white border-green-800 border-2 px-4 py-2.5 rounded-md text-xs sm:text-sm transition shadow-sm cursor-pointer flex-1 sm:flex-initial text-center leading-normal">Know Our Story</Link>
          </div>
